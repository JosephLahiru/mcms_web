    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>(navigate("/add_stock"))}>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>(navigate("/add_appointment1"))}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>(navigate("/add_appointment2"))}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>(navigate("/update_appointment"))}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
